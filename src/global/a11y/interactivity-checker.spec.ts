...
describe('Interactivity-checker', () => {
  ...
  describe('isVisible', () => {
    it('should return false for a `display: none` element', () => {
      ...
      expect(checker.isVisible(input)).toBe(false);
    });
    ...
    it.skip(
      ...
      () => {
        ...
        expect(checker.isVisible(input)).toBe(true);
      },
    );

    it.skip('should return true for an element without visibility modifiers', () => {
