...
export const mapIconToSvg: Record<string, SeatReservationIcon> = {
  ...
  MOBILE_PHONE_AREA: { svg: svgs.mobilePhone },
  MOBILE_PHONE_ICON: { svg: svgs.mobilePhone },
  MOBILE_PHONE_FORBIDDEN_AREA: { svg: svgs.mobilePhoneForbidden },
  MOBILE_PHONE_FORBIDDEN_ICON: { svg: svgs.mobilePhoneForbidden },
  ...
  WALL_LEFT_3: { svg: svgs.wallLeft3 },
  WALL_LEFT_2: { svg: svgs.wallLeft2 },
  WALL_LEFT_1: { svg: svgs.wallLeft1 },
  WALL_COMPARTMENTS_3: { svg: svgs.wallCompartments3 },
  WALL_COMPARTMENTS_2: { svg: svgs.wallCompartments2 },
  WALL_COMPARTMENTS_1: { svg: svgs.wallCompartments1 },
  WALL_RIGHT_3: { svg: svgs.wallRight3 },
  WALL_RIGHT_2: { svg: svgs.wallRight2 },
  WALL_RIGHT_1: { svg: svgs.wallRight1 },
  T_WALL_COMPARTMENTS_3: { svg: svgs.tWallCompartments3 },
  T_WALL_COMPARTMENTS_2: { svg: svgs.tWallCompartments2 },
  T_WALL_COMPARTMENTS_1: { svg: svgs.tWallCompartments1 },
