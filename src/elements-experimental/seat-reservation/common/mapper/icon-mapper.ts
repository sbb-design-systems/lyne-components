...
export const mapIconToSvg: Record<string, SeatReservationIcon> = {
  ...
  FAMILY_AREA: { svg: svgs.familyArea },
  LUGGAGE_AREA: { svgName: 'sa-ga' },
  LUGGAGE_ICON: { svgName: 'sa-ga' },
  MOBILE_PHONE_AREA: { svg: svgs.mobile },
  MOBILE_PHONE_ICON: { svg: svgs.mobile },
  MOBILE_PHONE_FORBIDDEN_AREA: { svg: svgs.mobileForbidden },
  MOBILE_PHONE_FORBIDDEN_ICON: { svg: svgs.mobileForbidden },
  ...
  PARTITION_WALL_LEFT_LONG: { svg: svgs.partitionWallLeftLong },
  PARTITION_WALL_LEFT_MEDIUM: { svg: svgs.partitionWallLeftMedium },
  PARTITION_WALL_LEFT_SHORT: { svg: svgs.partitionWallLeftShort },
  PARTITION_WALL_LONG: { svg: svgs.partitionWallLong },
  PARTITION_WALL_MEDIUM: { svg: svgs.partitionWallMedium },
  PARTITION_WALL_RIGHT_LONG: { svg: svgs.partitionWallRightLong },
  PARTITION_WALL_RIGHT_MEDIUM: { svg: svgs.partitionWallRightMedium },
  PARTITION_WALL_RIGHT_SHORT: { svg: svgs.partitionWallRightShort },
  PARTITION_WALL_SHORT: { svg: svgs.partitionWallShort },
  PARTITION_WALL_T_LONG: { svg: svgs.partitionWallTLong },
  PARTITION_WALL_T_MEDIUM: { svg: svgs.partitionWallTMedium },
  PARTITION_WALL_T_SHORT: { svg: svgs.partitionWallTShort },
