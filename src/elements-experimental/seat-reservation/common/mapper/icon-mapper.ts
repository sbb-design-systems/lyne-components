...
export const mapIconToSvg: Record<string, SeatReservationIcon> = {
  ...
  BISTRO: { svg: svgs.serviceBistro },
  BUSINESS: { svg: svgs.serviceBusiness },
  BUSINESS_COMFORT: { svg: svgs.serviceBusiness },
  FAMILY: { svg: svgs.serviceFamily },
  PRAM: { svgName: 'sa-abteilkinderwagen' },
  RESTAURANT: { svg: svgs.serviceRestaurant },
  SILENCE: { svgName: 'sa-rz' },
  WHEELCHAIR: { svg: svgs.serviceWheelchair },
  WHEELCHAIR_AND_SEAT: { svg: svgs.serviceWheelchair },
  WHEELCHAIR_NO_SEAT: { svg: svgs.serviceWheelchair },
