      ...
      <nav id="sbb-sr-navigation" class="sbb-sr-navigation">
        ...
        >
          ${this.seatReservation?.coachItems.map((coachItem: CoachItem, index: number) => {
            ...
            const driverAreaLeft = this._coachHasDriverArea(coachItem, 'beginning');
            const driverAreaRight = this._coachHasDriverArea(coachItem, 'end');
            return html`<li>
              <sbb-seat-reservation-navigation-coach
                ...
                ?first="${driverAreaLeft || index === 0}"
                ?last="${driverAreaRight || index === this.seatReservation?.coachItems.length - 1}"
