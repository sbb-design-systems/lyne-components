...
| `maxBicycleReservations` | `max-bicycle-reservations` | public  | `number`          | `null!` | Maximal number of possible clickable bicycle places               |
| `maxSeatReservations`    | `max-seat-reservations`    | public  | `number`          | `null!` | Maximal number of possible clickable seats                        |
