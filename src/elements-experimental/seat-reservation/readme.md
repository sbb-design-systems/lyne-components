...
type CoachType =
  'RESTAURANT_COACH' | 'BICYCLE_COACH' | 'LUGGAGE_COACH' | 'TRAIN_HEAD' | 'LOCOMOTIVE_COACH';
...
| `type`              | -                  | public  | `'button' \| 'reset' \| 'submit'`                     | `'button'`  | The type attribute to use for the button.                                                                                                                                                                                                                                                                                                                                                                                                               |
