...
export const mapCodeToSvg: Record<string, string> = {
  ...
  PLACE_BIKE_FREE: assets.interiorPlaceBikeDefault,
  PLACE_BIKE_SELECTED: assets.interiorPlaceBikeSelected,
  PLACE_BIKE_RESTRICTED: assets.interiorPlaceBikeNotBookable,
  PLACE_BIKE_ALLOCATED: assets.interiorPlaceBikeUnavailable,
