/** @entrypoint */
export * from './seat-reservation/common/mapper.ts';
export * from './seat-reservation/common/svgs.ts';
...
export * from './seat-reservation/seat-reservation-place-control/seat-reservation-place-control.component.ts';
