...
class SbbTimetableRowElement extends LitElement {
   ...
   */
  @property({ attribute: 'card-action-label' }) public accessor cardActionLabel: string = '';
  ...
  @property({ type: Boolean }) @forceType(Boolean) public accessor active: boolean = false;
