...
:root {
  // Override the font family for all text
...
Note that for the off-brand theme, font-faces are not included in the pre-rendered theme file,
so you can use the `off-brand-theme.css` file directly.
