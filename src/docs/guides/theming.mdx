...
| `--sbb-letter-spacing-text`    | Can be used to override the letter spacing for text               |
| `--sbb-letter-spacing-heading` | Can be used to override the letter spacing for headings           |
