...
| ----------------------------------- | ----------------------------------------------------------------- |
| `--sbb-typo-font-family`            | Can be used to override the font family for all text and headings |
| `--sbb-typo-letter-spacing-text`    | Can be used to override the letter spacing for text               |
| `--sbb-typo-letter-spacing-heading` | Can be used to override the letter spacing for headings           |
...
Note that for the off-brand theme, the `Inter` font is configured in the pre-rendered theme file,
so you can use the `off-brand-theme.css` file without any additional config.
...
| `off-brand-theme.css`             | Contains the standard theme with primary color set to an alternative color (blue) and doesn't include SBB fonts. |
...
| `lean-off-brand-theme.css`        | Contains the lean theme with primary color set to an alternative color (blue) and doesn't include SBB fonts.     |
