...
const Template = (args) => (
  <div>
    ...
    ************************************************* */}
    <sbb-section
      width="page-spacing"
      style="margin-inline-start: auto; margin-inline-end: auto; margin-block-end: calc(var(--spacing-responsive-l) / var(--typo-scale-default) * 1rem); padding-block-start: 7vh; max-width: 1440px; background-color: var(--color-milk-default);"
    >
      <sbb-grid slot="full-width" variant="base--eight-columns-centered">
        <sbb-stack
          slot="eight-columns-centered"
        ...
        >
          ...
          >
            <span
              ...
              style="min-width: 72px; width: 72px; height: 72px; background-color: var(--color-cloud-default); border-radius: 50%; display:flex;"
            ></span>
