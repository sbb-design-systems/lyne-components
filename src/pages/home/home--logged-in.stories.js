...
const Template = (args) => (
  <div>
    ...
    ************************************************* */}
    ...
    Products — Logged in
    ************************************************* */}
    <lyne-section width='page-spacing' style='padding-block-start: 7vh; margin-block-end: calc(var(--spacing-responsive-xl) / var(--typo-scale-default) * 1rem);; background-color: var(--color-milk-default); max-width: 1440px; margin-inline-start: auto; margin-inline-end: auto;'>
      <lyne-grid slot='full-width' variant='base--eight-columns-centered'>
