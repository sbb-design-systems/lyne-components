...
// Copied from https://github.com/angular/components/blob/main/src/cdk/testing/testbed/fake-events/event-objects.ts
 ...
 */
function defineReadonlyEventProperty(event: Event, propertyName: string, value: any): void {
