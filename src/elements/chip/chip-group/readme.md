...
| `displayWith`       | -                | public  | `((value: T) => string) \| null` | `null`      | Function that maps a chip's control value to its display value.                                                                                                                                                                                                                                                                                                                                                                                        |
...
| `value`             | `value`          | public  | `string[] \| null`               |             | Value of the form element.                                                                                                                                                                                                                                                                                                                                                                                                                             |
