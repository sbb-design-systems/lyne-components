...
export class SbbLogoElement extends SbbNegativeMixin(LitElement) {
  ...
  /**
   * Display the signet without text.
   *
   * @internal
   */
  @property({ attribute: 'signet-only', reflect: true, type: Boolean }) public signetOnly: boolean =
    false;
    ...
    return html`
      <span class="sbb-logo">
        <span class="sbb-logo__svg-container">
          ${this.signetOnly
            ? html` <svg focusable="false" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 143 48">
