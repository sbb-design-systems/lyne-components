...
| `selected`    | `selected`     | public  | `T \| T[] \| null`                       |                | The selected date. Takes T Object, ISOString, and Unix Timestamp (number of seconds since Jan 1, 1970). If `multiple`, takes an array of the mentioned types. |
