...
| `size`          | `size`           | public  | `string`                                                       | `'l'`        | Size variant, either s, m or l (default).                                                                                                                             |
...
| `negative`            | `negative`             | public  | `boolean`                         | `false`    | Negative coloring variant flag.                                                                                                                                                                                                                                                                                                                                                                                                                         |
| `size`                | `size`                 | public  | `'s' \| 'm' \| 'l' \| null`       | `'l'`      | Size variant, either s (lean theme default), m (standard theme default) or l.                                                                                                                                                                                                                                                                                                                                                                           |
