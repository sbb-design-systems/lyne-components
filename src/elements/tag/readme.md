...
| `size`                | `size`                 | public  | `'s' \| 'm' \| null`      | `null`  | Tag size, either s (lean default) or m (standard default). The value is inherited from the closest `<sbb-tag-group>`.                                                                                                                                                                                                                                                                                                                                   |
...
| `size`                   | `size`                     | public  | `'s' \| 'm'`                                 | `null`  | Tag group size, either s (lean default) or m (standard default).                                                                                                                                                                               |
