...
import { forceType, getOverride, slotState } from '../../core/decorators.js';
...
class SbbTagElement extends SbbIconNameMixin(SbbDisabledTabIndexActionMixin(SbbButtonBaseElement)) {
  ...
  @property({ reflect: true }) public accessor amount: string | null = null;

  /** Whether the tag is checked. */
  @property({ reflect: true, type: Boolean }) @forceType(Boolean) public accessor checked: boolean =
    false;
