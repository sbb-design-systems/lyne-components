...
snapshots["sbb-status renders A11y tree Safari"] = 
`<p>
  {
  "role": "WebArea",
  "name": "",
...
`;
/* end snapshot sbb-status renders A11y tree Safari */

snapshots["sbb-status renders with title A11y tree Safari"] = 
`<p>
  {
  "role": "WebArea",
  "name": "",
...
`;
/* end snapshot sbb-status renders with title A11y tree Safari */
