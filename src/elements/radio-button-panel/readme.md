...
### class: `SbbRadioButtonPanelElement`, `sbb-radio-button-panel`
...
| `size`                | `size`                  | public  | `SbbCheckboxSize \| SbbRadioButtonSize` | `null`    | Size variant, either xs (lean default), s or m (standard default).                                                                                                                                                                                                                                                                                                                                                                                      |
