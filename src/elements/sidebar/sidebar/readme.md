...
| `container`         | -          | public  | `C \| null`         | `null`    | Returns the SbbSidebarContainerElement where this sidebar is contained.                                                |
...
| `open`   | public  | Opens the sidebar.              |            | `Promise<void>` | SbbOpenCloseBaseElement |
