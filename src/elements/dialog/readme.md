...
| `buttonSize`     | `button-size`     | public  | `'s' \| 'm' \| 'l' \| null`                 | `null`         | Size of the nested sbb-button instances. This will overwrite the size attribute of nested sbb-button instances.<br><strong>Deprecated</strong>: Will be removed with next breaking change         |
| `horizontalFrom` | `horizontal-from` | public  | `'zero' \| 'small' \| 'large' \| 'ultra'`   | `'large'`      | Overrides the behavior of `orientation` property.                                                                                                                                                 |
| `linkSize`       | `link-size`       | public  | `'xs' \| 's' \| 'm' \| null`                | `null`         | Size of the nested sbb-block-link instances. This will overwrite the size attribute of nested sbb-block-link instances.<br><strong>Deprecated</strong>: Will be removed with next breaking change |
...
| `size`                | `size`                 | public  | `'s' \| 'm' \| 'l' \| null`       | `'s'`      | Size variant, either s (lean default), m (standard default) or l.                                                                                                                                                                                                                                                                                                                                                                                       |
