...
| `accessibilityTitleLevel` | `accessibility-title-level` | public  | `SbbHeadingLevel`              | `'1'`       | Level of the accessibility title, will be rendered as heading tag (e.g. h1). Defaults to level 1.                                                                                              |
