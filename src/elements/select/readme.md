...
| ------------------- | ------------- | ------- | ------------------------------------------- | -------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `compareWith`       | -             | public  | `(v1: T \| null, v2: T \| null) => boolean` |                                  | Function used to compare option values.                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
| `size`              | `size`        | public  | `'s' \| 'm' \| null`                        | `null`                           | Size variant, either s (lean default) or m (standard default). When placed inside an `<sbb-form-field>`, the size is inherited from the form field.                                                                                                                                                                                                                                                                                                     |
