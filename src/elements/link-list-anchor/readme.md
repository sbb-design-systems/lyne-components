...
### class: `SbbLinkListAnchorElement`, `sbb-link-list-anchor`
...
| `size`         | `size`          | public  | `SbbBlockLinkCommonElementMixinType['size']` | `'s' / 'xs' (lean)` | Text size of the nested sbb-block-link instances. This will overwrite the size attribute of nested sbb-block-link instances. |
