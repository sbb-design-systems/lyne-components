...
class SbbImageElement extends LitElement {
   ...
   */
  @property() public accessor alt: string = '';
   ...
   */
  @property({ attribute: 'skip-lqip', type: Boolean })
  @forceType(Boolean)
   ...
   */
  @property() public accessor caption: string = '';
   ...
   * information.
   */
  @property() public accessor copyright: string = '';
   ...
   */
  @property({ attribute: 'focal-point-x', type: Number }) public accessor focalPointX: number = 1;

  /**
   * Pass in a floating number between 0 (top) and 1 (bottom).
   */
  @property({ attribute: 'focal-point-y', type: Number }) public accessor focalPointY: number = 1;
   ...
   */
  @property({ attribute: 'performance-mark' }) public accessor performanceMark: string = '';
   ...
   *  }
   */
  @property({ attribute: 'picture-sizes-config' }) public accessor pictureSizesConfig: string = '';
