...
| -------------------------------- | ----------------------------------- | ------- | ------------------ | ------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `accessibilityNextPageLabel`     | `accessibility-next-page-label`     | public  | `'string' \| null` | `null`             | Accessibility label for the next page. Defaults to `next page`. Can be set for cases like a carousel, where `slide` or `image` fits better.                                       |
| `accessibilityPageLabel`         | `accessibility-page-label`          | public  | `'string' \| null` | `null`             | Accessibility label for the page. Defaults to `page`. Can be set for cases like a carousel, where `slide` or `image` fits better.                                                 |
| `accessibilityPreviousPageLabel` | `accessibility-previous-page-label` | public  | `'string' \| null` | `null`             | Accessibility label for the previous page. Defaults to `previous page`. Can be set for cases like a carousel, where `slide` or `image` fits better.                               |
