...
snapshots["sbb-secondary-button-link renders a sbb-secondary-button-link without icon A11y tree Safari"] = 
`<p>
  {
  "role": "WebArea",
  "name": "",
...
`;
/* end snapshot sbb-secondary-button-link renders a sbb-secondary-button-link without icon A11y tree Safari */
