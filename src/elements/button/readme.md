...
| `size`                | `size`                 | public  | `SbbButtonCommonElementMixinType['size']` | `'m' / 's' (lean)` | Size variant, either l, m or s.                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
| `negative`           | `negative`            | public  | `boolean`                   | `false`            | Negative coloring variant flag.                                             |
| `size`               | `size`                | public  | `'s' \| 'm' \| 'l' \| 'xl'` | `'m' / 's' (lean)` | Size variant, either s, m, l or xl.                                         |
