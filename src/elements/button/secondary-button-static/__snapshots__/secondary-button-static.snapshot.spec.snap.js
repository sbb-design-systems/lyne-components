...
snapshots["sbb-secondary-button-static renders with slotted icon A11y tree Safari"] = 
`<p>
  {
  "role": "WebArea",
  "name": "",
...
`;
/* end snapshot sbb-secondary-button-static renders with slotted icon A11y tree Safari */
