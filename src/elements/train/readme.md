...
| `directionLabelLevel` | `direction-label-level` | public  | `'1' \| '2' \| '3' \| '4' \| '5' \| '6'` | `'6'`    | Heading level of the direction label, used for screen readers.                               |
...
| Name          | Attribute     | Privacy | Type                         | Default        | Description                                                     |
| ------------- | ------------- | ------- | ---------------------------- | -------------- | --------------------------------------------------------------- |
| `orientation` | `orientation` | public  | `'horizontal' \| 'vertical'` | `'horizontal'` | Orientation, either horizontal or vertical.                     |
...
| `occupancy`                   | `occupancy`                     | public  | `'high' \| 'medium' \| 'low' \| 'none' \| null`                                                                             | `null`     | Occupancy of a wagon.                                                                                                                                                                                                                                                                                                                                                                                                                                   |
