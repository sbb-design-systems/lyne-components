...
| `value`             | `value`         | public  | `string`                          | `null`    | The value of the date input. Reflects the current text value of this input. The attribute `value` Accepts ISO8601 formatted values, which will be formatted according to the current locale.                                                                                                                                                                                                                                                           |
