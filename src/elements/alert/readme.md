...
| `accessibilityTitleLevel` | `accessibility-title-level` | public  | `SbbHeadingLevel` | `'2'`   | Level of the accessibility title, will be rendered as heading tag (e.g. h2). Defaults to level 2. |
