...
class SbbAlertElement extends SbbIconNameMixin(SbbOpenCloseBaseElement) {
   ...
   */
  @property({ attribute: 'icon-name' }) public override accessor iconName: string = 'info';

  /** Content of title. */
  @property({ attribute: 'title-content' }) public accessor titleContent: string = '';
  ...
  /** Content of the link. */
  @property({ attribute: 'link-content' }) public accessor linkContent: string = '';
