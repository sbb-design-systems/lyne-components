...
| --------------------- | ------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------- | -------------------- |
| `appearance`          | `appearance` | appearance of the Cus Him display, can either be an icon only list appearance or a single icon with text                                                                                                                                                                                                 | `"first-level-list" \| "second-level-list" \| "second-level-message"` | `'first-level-list'` |
