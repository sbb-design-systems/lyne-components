...
| `variant`             | `variant` | Variant of the Cus Him display, can either be an icon only list variant or a single icon with text                                                                                                                                                                                                       | `"first-level-list" \| "second-level-list" \| "second-level-text"` | `'first-level-list'` |
