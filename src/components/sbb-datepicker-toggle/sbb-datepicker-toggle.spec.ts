  ...
  it('renders', async () => {
    ...
    expect(page.root).toEqualHtml(`
      <sbb-datepicker-toggle slot="prefix">
        <mock:shadow-root>
          <sbb-tooltip-trigger accessibilityLabel="Show calendar" iconName="calendar-small" disabled=""></sbb-tooltip-trigger>
  ...
  describe('renders in form-field', () => {
    it('renders in form-field', async () => {
      ...
      expect(element).toEqualHtml(`
        <sbb-datepicker-toggle slot="prefix">
          <mock:shadow-root>
            <sbb-tooltip-trigger accessibilityLabel="Show calendar" iconName="calendar-small"></sbb-tooltip-trigger>
            <sbb-tooltip data-hide-close-button="">
