...
snapshots["sbb-button renders a button with slotted icon Dom"] = 
`<sbb-button
...
`;
/* end snapshot sbb-button renders a button with slotted icon Dom */

snapshots["sbb-button renders a button with slotted icon ShadowDom"] = 
`<span class="sbb-button">
  <span class="sbb-button__icon">
    <slot name="icon">
    </slot>
...
`;
/* end snapshot sbb-button renders a button with slotted icon ShadowDom */
