...
| `namedSlots` | -           | public  |                                                                                |                                | State of listed named slots, by indicating whether any element for a named slot is defined.                                                            |
| `hasText`    | -           | public  | `boolean`                                                                      | `false`                        |                                                                                                                                                        |
| `language`   | -           | public  |                                                                                | `new LanguageController(this)` |                                                                                                                                                        |
...
| ------------------- | ------- | ----------- | -------------- | ------ | --------------------------- |
| `onLabelSlotChange` | public  |             | `event: Event` | `void` | SbbButtonCommonElementMixin |
