...
| -------------------------- | ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------- | ----------- |
| `appearance`               | `appearance`        | Journey header appearance                                                                                                                                                                              | `"primary" \| "primary-negative"`                               | `'primary'` |
| `destination` _(required)_ | `destination`       | Destination location for the journey header                                                                                                                                                            | `string`                                                        | `undefined` |
| `isRoundTrip`              | `is-round-trip`     | Is the journey a round trip. If so it gets indicated through a roundtrip icon                                                                                                                          | `boolean`                                                       | `undefined` |
