...
| `actionHeaderId`           | `action-header-id`          | Action element's id.                                                                                                                                                                   | `string`                                                                   | ``sbb-action-header-${++nextId}`` |
...
| `icon`                     | `icon`                      | The icon name used in the action element. See sbb-icon components for more details.                                                                                                    | `string`                                                                   | `undefined`                       |
