...
const ssrModules = ['./menu-action.ts'];
for (const fixture of [csrFixture, ssrHydratedFixture]) {
  describe(`sbb-menu-action rendered with ${fixture.name}`, () => {
    ...
    it('renders as a button and triggers click event', async () => {
      element = await fixture(html`<sbb-menu-action></sbb-menu-action>`, { modules: ssrModules });
