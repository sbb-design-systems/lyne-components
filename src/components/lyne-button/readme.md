...
| `variant`          | `variant`            | Variant of the button, like primary, secondary etc.                                                                                             | `"primary" \| "primary-negative" \| "secondary" \| "secondary-negative" \| "tertiary" \| "tertiary-negative" \| "translucent" \| "translucent-negative" \| "transparent" \| "transparent-negative"` | `'primary'` |
