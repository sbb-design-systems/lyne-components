# sbb-link-list
The `<sbb-link-list>` is a collection of sbb-links. It has an optional title which stays visually always on level 5. The title is used as the aria-labelledby attribute of the ul element. The list can be oriented vertically or 
