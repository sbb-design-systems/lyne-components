...
const TemplateBadge = (args) => (
  <sbb-timetable-row {...args}>
    <sbb-card-badge slot="badge" {...args}></sbb-card-badge>
    <sbb-icon style="color:" slot="pictogram" name="train-small"></sbb-icon>
    <sbb-icon slot="transportNumber" name="ic-6"></sbb-icon>
    <p slot="direction">Richtung RonshornStraße</p>
...
export const SbbTimetableRowWithBadge = TemplateBadge.bind({});
SbbTimetableRowWithBadge.argTypes = defaultArgTypes;
SbbTimetableRowWithBadge.args = {
