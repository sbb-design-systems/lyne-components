...
describe('sbb-autocomplete-item', () => {
  it('renders', async () => {
    const { root } = await newSpecPage({
      ...
      html: '<sbb-autocomplete-item-deprecated text="lorem ipsum item1 dolor sit" highlight="tem"></sbb-autocomplete-item-deprecated>',
    });

    expect(root).toEqualHtml(`
        <sbb-autocomplete-item-deprecated highlight="tem" text="lorem ipsum item1 dolor sit">
          <mock:shadow-root>
