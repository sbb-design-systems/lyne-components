...
| `variant`             | `variant` | Variant of the Transportation number display, can either be used on level 1 or level 2 of the timetable                                                                                                                                                                                                | `"first-level" \| "second-level"` | `'first-level'` |
