...
import { isChromium, isFirefox } from '../../core/dom/index.js';
import { EventSpy, waitForCondition, waitForLitRender } from '../../core/testing/index.js';
import { fixture } from '../../core/testing/private/index.js';
import type { SbbVisualCheckboxElement } from '../../visual-checkbox/index.js';
...
describe(`sbb-checkbox-panel with ${fixture.name}`, () => {
  ...
  describe('comparing with native checkbox', () => {
    let element: HTMLInputElement | SbbCheckboxPanelElement,
    ...
    ['input', 'sbb-checkbox-panel'].forEach((selector) => {
      describe(selector, () => {
