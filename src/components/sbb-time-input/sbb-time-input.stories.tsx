...
const updateFormError = (event: CustomEvent): void => {
  ...
  const target = event.target as HTMLSbbTimeInputElement;
  const formField = target.closest('sbb-form-field');

  const formError: HTMLSbbFormErrorElement = document.createElement('sbb-form-error');
  ...
  <div id="example-parent">
    ...
    >
      ...
      <sbb-time-input
        ...
        onValidationChange={(event) => updateFormError(event)}
      ></sbb-time-input>
