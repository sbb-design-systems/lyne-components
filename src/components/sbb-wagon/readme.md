...
| ---------------------------------- | ------------------------------------- | ------------------------------------------------------------------------------------------------- | --------------------------------------- | ------------------------------------ |
| `accessibilityAdditionalWagonText` | `accessibility-additional-wagon-text` | Accessibility text for translations to add additional description for wagon                       | `string`                                | `''`                                 |
...
| `label`                            | `label`                               | Visible label for the wagon number                                                                | `string`                                | `undefined`                          |
