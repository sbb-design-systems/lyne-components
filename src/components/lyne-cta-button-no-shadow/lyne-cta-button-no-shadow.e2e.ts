...
describe('lyne-cta-button-no-shadow', () => {
  ...
  beforeEach(async () => {
    ...
    await page.setContent('<lyne-cta-button-no-shadow></lyne-cta-button-no-shadow>');
    element = await page.find('lyne-cta-button-no-shadow');
  });
  ...
  it('renders button text', async () => {
    ...
    const button = await page.find('lyne-cta-button-no-shadow .label');
  ...
  describe('events', () => {
    it('dispatches event on click', async () => {
      ...
      await page.waitForChanges();
      const button = await page.find('lyne-cta-button-no-shadow button');
