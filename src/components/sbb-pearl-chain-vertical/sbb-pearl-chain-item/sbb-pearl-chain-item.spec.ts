...
describe('sbb-pearl-chain-item', () => {
      ...
      <mock:shadow-root>
        <div class="sbb-pearl-chain-item" style="display: table-row;">
          ...
          <div class="sbb-pearl-chain-item__row--middle" style="display: table-cell;">
            <div class="sbb-color__red sbb-pearl-chain-item__dot--standard sbb-pearl-chain-item__dot-size--undefined"></div>
          </div>
    ...
    <sbb-pearl-chain-item class="sbb-pearl-chain-item" pearlchainitemattributes="">
      <mock:shadow-root>
        <div class="sbb-pearl-chain-item" style="display: table-row;">
          ...
          <div class="sbb-pearl-chain-item__row--middle" style="display: table-cell;">
            <div class="sbb-color__gray sbb-pearl-chain-item__dot--standard sbb-pearl-chain-item__dot-size--undefined"></div>
          </div>
          <div class="sbb-pearl-chain-item__row--right" style="display: table-cell;">
            <slot name="right"></slot>
          </div>
    ...
    <sbb-pearl-chain-item class="sbb-pearl-chain-item" pearlchainitemattributes="">
      <mock:shadow-root>
        <div class="sbb-pearl-chain-item" style="display: table-row;">
          ...
          <div class="sbb-pearl-chain-item__row--middle" style="display: table-cell;">
            <div class="sbb-color__black sbb-pearl-chain-item__dot--thick-bullet sbb-pearl-chain-item__dot-size--undefined"></div>
          </div>
          <div class="sbb-pearl-chain-item__row--right" style="display: table-cell;">
            <slot name="right"></slot>
          </div>
  ...
  it('renders a position', async () => {
    ...
    expect(page.root)
      .toEqualHtml(`<sbb-pearl-chain-item class="sbb-pearl-chain-item" pearlchainitemattributes="">
    <mock:shadow-root>
      <div class="sbb-pearl-chain-item" style="display: table-row;">
        <div class="sbb-pearl-chain-item__row--left" style="display: table-cell; height: 100px;">
          <div class="sbb-pearl-chain-item__left-slot">
        ...
        <div class="sbb-pearl-chain-item__row--middle" style="display: table-cell;">
          <div class="sbb-color__gray sbb-pearl-chain-item__dot--thick-bullet sbb-pearl-chain-item__dot-size--undefined"></div>
