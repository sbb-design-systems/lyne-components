...
| `value`                  | `value`                    | public  | `string \| string[] \| null` |         | Value of the sbb-tag-group. If set multiple to false, the value is a string (or null). If set multiple to true, the value is an array.                                                                                                          |
