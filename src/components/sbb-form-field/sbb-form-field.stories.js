...
const TemplateInputWithError = (args) => (
  <sbb-form-field {...args}>
    <input slot='input' class='input' placeholder='Name' />
    <sbb-form-error idError='pippo' slot='error'>This is a required field.</sbb-form-error>
  </sbb-form-field>
);
...
const TemplateSelectWithError = (args) => (
  <sbb-form-field {...args}>
    ...
    <sbb-form-error idError='error' slot='error'>This is a required field.</sbb-form-error>
  </sbb-form-field>
);
