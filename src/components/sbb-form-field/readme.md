...
| --------------- | --------------- | ------- | ------------------------------------------------------ | ----------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `errorSpace`    | `error-space`    | public  | `'none' \| 'reserve' \| undefined`                     | Whether to reserve space for an error message.&#xA;\`none\` does not reserve any space.&#xA;\`reserve\` does reserve one row for an error message.                                |                |
| `label`         | `label`         | public  | `string`                                               |             | Label text for the input which is internally rendered as \`\<label>\`.                                                                                                            |
| `optional`      | `optional`      | public  | `boolean \| undefined`                                 |             |                |
| `size`          | `size`          | public  | `'l' \| 'm' \| undefined`                              | Size variant, either l or m.                                                                                                                                                      |                |
| `borderless`    | `borderless`    | public  | `boolean`                                              | `false`     | Whether to display the form field without a border.                                                                                                                               |
| `width`         | `width`         | public  | `'default' \| 'collapse'`                              | `'default'` |                |
