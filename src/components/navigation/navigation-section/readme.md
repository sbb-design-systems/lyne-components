...
| `trigger`                | `trigger`                  | public  | `string \| HTMLElement`      | `null`  | The element that will trigger the navigation section. Accepts both a string (id of an element) or an HTML element. |
