...
| `variant`             | `variant` | Variant of the Travel Hints display, can either be used on level 1 or level 2 of the timetable                                                                                                                                                                                                           | `"first-level-list" \| "second-level-list"` | `'first-level-list'` |
