...
import { shadowInputElement } from '../../global/dom';
import {
  HandlerRepository,
...
export class SbbToggleCheck implements ComponentInterface {
  ...
  public handleClick(event: Event): void {
    if (!this.disabled && getEventTarget(event) === this._element) {
      shadowInputElement(this._element).click();
    }
  }
  ...
  public handleKeyup(event: KeyboardEvent): void {
    ...
    if (!this.disabled && event.key === ' ') {
      ...
      setTimeout(() => shadowInputElement(this._element).click());
    }
  }
  ...
  public handleInputEvent(): void {
    this.checked = shadowInputElement(this._element)?.checked ?? false;
  }
