...
describe('lyne-teaser-hero', () => {
  it('renders', async () => {
    const {
      ...
      html: '<lyne-teaser-hero button-text="Button text" image-src="https://cdn.img.sbb.ch/content/dam/internet/lyne/Billetkontrolle.jpg" text="Panel text"></lyne-teaser-hero>'
    });

    expect(root)
      .toEqualHtml(`
        <lyne-teaser-hero button-text="Button text" image-src="https://cdn.img.sbb.ch/content/dam/internet/lyne/Billetkontrolle.jpg" text="Panel text">
          <mock:shadow-root>
