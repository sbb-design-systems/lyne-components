...
describe('sbb-pearl-chain-vertical-item', () => {
  it('renders component with charcoal standard line and dot', async () => {
    ...
    <mock:shadow-root>
      ...
      <div class="sbb-pearl-chain-vertical-item__column  sbb-pearl-chain-vertical-item__column--middle">
        ...
        <div class="sbb-color--charcoal sbb-pearl-chain-vertical-item__dot sbb-pearl-chain-vertical-item__dot--standard sbb-pearl-chain-vertical-item__dot-size--m"></div>
      </div>
  ...
  it('renders component with red line and dot', async () => {
    ...
    <mock:shadow-root>
      ...
      <div class="sbb-pearl-chain-vertical-item__column sbb-pearl-chain-vertical-item__column--middle">
        ...
        <div class="sbb-color--red sbb-pearl-chain-vertical-item__dot sbb-pearl-chain-vertical-item__dot--standard sbb-pearl-chain-vertical-item__dot-size--m"></div>
      </div>
      <div class="sbb-pearl-chain-vertical-item__column sbb-pearl-chain-vertical-item__column--right">
        <slot name="right"></slot>
      </div>
  ...
  it('renders component with left slot', async () => {
    ...
    <mock:shadow-root>
      ...
      <div class="sbb-pearl-chain-vertical-item__column sbb-pearl-chain-vertical-item__column--middle">
        <div class="sbb-color--metal sbb-pearl-chain-vertical-item__dot sbb-pearl-chain-vertical-item__dot--standard sbb-pearl-chain-vertical-item__dot-size--m"></div>
      </div>
      <div class="sbb-pearl-chain-vertical-item__column sbb-pearl-chain-vertical-item__column--right">
        <slot name="right"></slot>
      </div>
  ...
  it('renders component with right slot', async () => {
    ...
    <mock:shadow-root>
      ...
      <div class="sbb-pearl-chain-vertical-item__column sbb-pearl-chain-vertical-item__column--middle">
        <div class="sbb-color--charcoal sbb-pearl-chain-vertical-item__dot sbb-pearl-chain-vertical-item__dot--thick-bullet sbb-pearl-chain-vertical-item__dot-size--s"></div>
      </div>
      <div class="sbb-pearl-chain-vertical-item__column sbb-pearl-chain-vertical-item__column--right ">
        <slot name="right"></slot>
      </div>
    ...
    expect(page.root).toEqualHtml(`
      <sbb-pearl-chain-vertical-item pearlChainVerticalItemAttributes="">
        <mock:shadow-root>
          ...
          <div class="sbb-pearl-chain-vertical-item__column sbb-pearl-chain-vertical-item__column--middle">
            <div class="sbb-color--charcoal sbb-pearl-chain-vertical-item__dot sbb-pearl-chain-vertical-item__dot--thick-bullet sbb-pearl-chain-vertical-item__dot-size--m"></div>
          </div>
          <div class="sbb-pearl-chain-vertical-item__column  sbb-pearl-chain-vertical-item__column--right">
            <slot name="right"></slot>
          </div>
    ...
    expect(page.root).toEqualHtml(`
      <sbb-pearl-chain-vertical-item pearlchainverticalitemattributes="">
        <mock:shadow-root>
          ...
          <div class="sbb-pearl-chain-vertical-item__column sbb-pearl-chain-vertical-item__column--middle">
            <div class="sbb-color--metal sbb-pearl-chain-vertical-item__dot sbb-pearl-chain-vertical-item__dot--double-bullet sbb-pearl-chain-vertical-item__dot-size--m"></div>
    ...
    expect(page.root).toEqualHtml(`
      <sbb-pearl-chain-vertical-item pearlchainverticalitemattributes="">
        <mock:shadow-root>
          ...
          <div class="sbb-pearl-chain-vertical-item__column sbb-pearl-chain-vertical-item__column--middle">
            <div class="sbb-color--charcoal sbb-pearl-chain-vertical-item__dot sbb-pearl-chain-vertical-item__dot--crossed-bullet sbb-pearl-chain-vertical-item__dot-size--m"></div>
          </div>
          <div class="sbb-pearl-chain-vertical-item__column sbb-pearl-chain-vertical-item__column--right">
            <slot name="right"></slot>
          </div>
