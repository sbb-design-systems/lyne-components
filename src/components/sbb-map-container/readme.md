...
and the sidebar content is scrolling over the map. On desktop is the sidebar and the map in a two column layout side by
side.The component come along with a height calculation that subtracts the height of the header. The header height can
