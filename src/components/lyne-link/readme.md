...
| `iconFlip` _(required)_  | `icon-flip`      | Decide wheter the icon should get flipped horizontally if the document writing mode is changed from Left to Right to Right to left and vice versa. | `boolean`                  | `undefined`  |
