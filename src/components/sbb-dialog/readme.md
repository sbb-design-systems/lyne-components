...
| `titleId`                  | `title-id`                  | This id will be forwarded to the relevant inner element.                                                                                                       | `string`                                 | ``sbb-dialog-title-${++nextId}`` |
| `titleLevel`               | `title-level`               | This level will correspond to the heading tag generated in the title. Use this property to generate the appropriate header tag, taking SEO into consideration. | `"1" \| "2" \| "3" \| "4" \| "5" \| "6"` | `'1'`                            |
