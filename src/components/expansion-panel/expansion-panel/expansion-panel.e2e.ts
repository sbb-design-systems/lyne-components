...
const ssrModules = ['./expansion-panel.ts'];
for (const fixture of [csrFixture, ssrHydratedFixture]) {
  describe(`sbb-expansion-panel rendered with ${fixture.name}`, () => {
    ...
    it('click the header expands the panel, click again collapses it', async () => {
      ...
      const content: SbbExpansionPanelContent = element.querySelector(
