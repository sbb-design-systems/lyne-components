...
| `href`                     | `href`                      | The href value you want to link to (optional, if its not present link becomes a button)                                                                                                    | `string`                          | `undefined` |
...
| `iconPlacement`            | `icon-placement`            | Moves the icon to the end of the component if set to true (optional).                                                                                                                      | `"end" \| "start"`                | `'start'`   |
