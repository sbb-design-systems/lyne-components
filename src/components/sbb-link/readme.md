...
| ------------------- | ---------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------- | ----------- |
| `ariaText`          | `aria-text`      | The aria-label attribute text. (optional)                                                                                                                                                  | `string`                                                       | `undefined` |
...
| `isStatic`          | `is-static`      | If this is set to true an span element will be used instead of a anchor or a button                                                                                                        | `boolean`                                                      | `false`     |
