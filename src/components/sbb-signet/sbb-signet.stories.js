...
NoProtectiveRoom.args = { ...defaultArgs, 'protective-room': protectiveRoom.options[2] };
...
IdealProtectiveRoom.args = { ...defaultArgs, 'protective-room': protectiveRoom.options[0] };
