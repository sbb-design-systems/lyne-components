...
| `inputBorderless`         | `input-borderless`       | Define if borderless variant of autocomplete input should be used. See documentation of lyne-text-input for details.                                              | `boolean` | `true`                                                                                                                                                                                                                                                                                                                                                                                                       |
...
| `inputLabelVisible`       | `input-label-visible`    | Determine if the input label should be visible. See lyne-text-input for details.                                                                                  | `boolean` | `true`                                                                                                                                                                                                                                                                                                                                                                                                       |
