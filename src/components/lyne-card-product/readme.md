...
| `hasButtonBehaviour`              | `has-button-behaviour` | Defines if the card behaves like a HTML button. Needs to be set true if the card does not point to a URL.                                                                                                                                                                                             | `boolean`                                                       | `undefined`  |
