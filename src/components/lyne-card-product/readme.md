...
| --------------------------------- | ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------- | ------------ |
| `accessibilityLabel` _(required)_ | `accessibility-label`  | The text which gets exposed to screen reader users. The text should reflect all the information which gets passed into the component's slots and which is visible in the card, either through text or iconography. E.g. Connection from X to Y, via Z, on date X. Price starts at X. | `string`                                                        | `undefined`  |
...
| `hasButtonBehaviour`              | `has-button-behaviour` | Defines if the card behaves like a HTML button.                                                                                                                                                                                                                                      | `boolean`                                                       | `undefined`  |
| `hrefValue`                       | `href-value`           | The href value you want to link to                                                                                                                                                                                                                                                   | `string`                                                        | `undefined`  |
| `idValue`                         | `id-value`             | The ID value you want to reference                                                                                                                                                                                                                                                   | `string`                                                        | `undefined`  |
