...
declare global {
  ...
  interface HTMLSbbAutocompleteItemElement
    extends Components.SbbAutocompleteItem,
      HTMLStencilElement {}
  ...
  interface HTMLSbbTimetableRowButtonElement
    extends Components.SbbTimetableRowButton,
      HTMLStencilElement {}
  var HTMLSbbTimetableRowButtonElement: {
    prototype: HTMLSbbTimetableRowButtonElement;
    new (): HTMLSbbTimetableRowButtonElement;
  };
  interface HTMLSbbTimetableRowColumnHeadersElement
    extends Components.SbbTimetableRowColumnHeaders,
      HTMLStencilElement {}
  ...
  interface HTMLSbbTimetableRowDayChangeElement
    extends Components.SbbTimetableRowDayChange,
      HTMLStencilElement {}
  ...
  interface HTMLSbbTimetableRowHeaderElement
    extends Components.SbbTimetableRowHeader,
      HTMLStencilElement {}
  var HTMLSbbTimetableRowHeaderElement: {
    prototype: HTMLSbbTimetableRowHeaderElement;
    new (): HTMLSbbTimetableRowHeaderElement;
  };
  interface HTMLSbbTimetableTransportationDetailsElement
    extends Components.SbbTimetableTransportationDetails,
      HTMLStencilElement {}
  ...
  interface HTMLSbbTimetableTransportationNumberElement
    extends Components.SbbTimetableTransportationNumber,
      HTMLStencilElement {}
  ...
  interface HTMLSbbTimetableTransportationTimeElement
    extends Components.SbbTimetableTransportationTime,
      HTMLStencilElement {}
  ...
  interface HTMLSbbTimetableTransportationWalkElement
    extends Components.SbbTimetableTransportationWalk,
      HTMLStencilElement {}
  ...
  interface HTMLSbbTimetableTravelHintsElement
    extends Components.SbbTimetableTravelHints,
      HTMLStencilElement {}
...
declare module '@stencil/core' {
  export namespace JSX {
    interface IntrinsicElements {
      ...
      'sbb-accordion-item': LocalJSX.SbbAccordionItem &
        JSXBase.HTMLAttributes<HTMLSbbAccordionItemElement>;
      'sbb-autocomplete': LocalJSX.SbbAutocomplete &
        JSXBase.HTMLAttributes<HTMLSbbAutocompleteElement>;
      'sbb-autocomplete-item': LocalJSX.SbbAutocompleteItem &
        JSXBase.HTMLAttributes<HTMLSbbAutocompleteItemElement>;
      ...
      'sbb-card-product': LocalJSX.SbbCardProduct &
        JSXBase.HTMLAttributes<HTMLSbbCardProductElement>;
      ...
      'sbb-journey-header': LocalJSX.SbbJourneyHeader &
        JSXBase.HTMLAttributes<HTMLSbbJourneyHeaderElement>;
      ...
      'sbb-slot-component': LocalJSX.SbbSlotComponent &
        JSXBase.HTMLAttributes<HTMLSbbSlotComponentElement>;
      ...
      'sbb-timetable-barrier-free': LocalJSX.SbbTimetableBarrierFree &
        JSXBase.HTMLAttributes<HTMLSbbTimetableBarrierFreeElement>;
      'sbb-timetable-button': LocalJSX.SbbTimetableButton &
        JSXBase.HTMLAttributes<HTMLSbbTimetableButtonElement>;
      'sbb-timetable-cus-him': LocalJSX.SbbTimetableCusHim &
        JSXBase.HTMLAttributes<HTMLSbbTimetableCusHimElement>;
      'sbb-timetable-duration': LocalJSX.SbbTimetableDuration &
        JSXBase.HTMLAttributes<HTMLSbbTimetableDurationElement>;
      'sbb-timetable-occupancy': LocalJSX.SbbTimetableOccupancy &
        JSXBase.HTMLAttributes<HTMLSbbTimetableOccupancyElement>;
      'sbb-timetable-park-and-rail': LocalJSX.SbbTimetableParkAndRail &
        JSXBase.HTMLAttributes<HTMLSbbTimetableParkAndRailElement>;
      'sbb-timetable-platform': LocalJSX.SbbTimetablePlatform &
        JSXBase.HTMLAttributes<HTMLSbbTimetablePlatformElement>;
      'sbb-timetable-row': LocalJSX.SbbTimetableRow &
        JSXBase.HTMLAttributes<HTMLSbbTimetableRowElement>;
      'sbb-timetable-row-button': LocalJSX.SbbTimetableRowButton &
        JSXBase.HTMLAttributes<HTMLSbbTimetableRowButtonElement>;
      'sbb-timetable-row-column-headers': LocalJSX.SbbTimetableRowColumnHeaders &
        JSXBase.HTMLAttributes<HTMLSbbTimetableRowColumnHeadersElement>;
      'sbb-timetable-row-day-change': LocalJSX.SbbTimetableRowDayChange &
        JSXBase.HTMLAttributes<HTMLSbbTimetableRowDayChangeElement>;
      'sbb-timetable-row-header': LocalJSX.SbbTimetableRowHeader &
        JSXBase.HTMLAttributes<HTMLSbbTimetableRowHeaderElement>;
      'sbb-timetable-transportation-details': LocalJSX.SbbTimetableTransportationDetails &
        JSXBase.HTMLAttributes<HTMLSbbTimetableTransportationDetailsElement>;
      'sbb-timetable-transportation-number': LocalJSX.SbbTimetableTransportationNumber &
        JSXBase.HTMLAttributes<HTMLSbbTimetableTransportationNumberElement>;
      'sbb-timetable-transportation-time': LocalJSX.SbbTimetableTransportationTime &
        JSXBase.HTMLAttributes<HTMLSbbTimetableTransportationTimeElement>;
      'sbb-timetable-transportation-walk': LocalJSX.SbbTimetableTransportationWalk &
        JSXBase.HTMLAttributes<HTMLSbbTimetableTransportationWalkElement>;
      'sbb-timetable-travel-hints': LocalJSX.SbbTimetableTravelHints &
        JSXBase.HTMLAttributes<HTMLSbbTimetableTravelHintsElement>;
