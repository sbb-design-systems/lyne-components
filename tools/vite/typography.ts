  ...
  return {
    ...
    async generateBundle() {
      const sheets = [
        ...
        { inputName: 'core/styles/brandless-theme.scss', outputName: 'brandless-theme.css' },
        ...
        {
          inputName: 'core/styles/safety-relevant-theme.scss',
          outputName: 'safety-relevant-theme.css',
        },
